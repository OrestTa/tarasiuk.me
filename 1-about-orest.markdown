...
- Apriori's Deeply Intents: [Background behind Cross-Chain Money Legos](https://x.com/apriori0x/status/2002021677559873932){:target="_blank"} (podcast)
- Devconnect Buenos Aires 2025: [Cross-Chain Apps Enabled by t1 Real-Time Proving](https://youtu.be/hLZGUSkRusE){:target="_blank"}
- DeFi Connect Buenos Aires: [TEE-Based Cross-Chain Oracles for Interop](https://youtu.be/6o4_GBzFUzM){:target="_blank"}
...
- BanklessDAO: [Scroll Testnet Pre-Announcement at ETHBarcelona](https://twitter.com/banklessDAO/status/1559230832598032384){:target="_blank"} (interview)
